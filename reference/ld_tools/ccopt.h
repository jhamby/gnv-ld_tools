...
/* Parameters:
      ...
      support - Support status
              ...
              - t64usup: Unsupported Tru64 on VMS need to warn.
...
_X_ARG( "spike"			, control, noval, 0		, 0  , tru64 ),
...
_X_ARG( "SD"		, compile, xval	, 0	      , 0           , tru64 ),
...
_X_ARG( "Zp"		, compile, noval, 0	      , 0           , tru64 ),
_X_ARG( "Zp1"		, compile, noval, 0	      , 0           , tru64 ),
_X_ARG( "Zp2"		, compile, noval, 0	      , 0           , tru64 ),
_X_ARG( "Zp4"		, compile, noval, 0	      , 0           , tru64 ),
_X_ARG( "Zp8"		, compile, noval, 0	      , 0           , tru64 ),
_X_ARG( "accept" 	, compile, val	, accept      , ""          , deprec ),
_X_ARG( "ansi_alias"	, compile, noval, 0	      , "/ANS"      , tru64 ),
_X_ARG( "ansi_args"	, compile, noval, 0	      , 0           , tru64 ),
_X_ARG( "arch" 		, compile, val	, 0	      , "/ARC"      , tru64 ),
_X_ARG( "assume" 	, compile, val	, assume      , ""          , tru64 ),
_X_ARG( "c99"		, compile, noval, 0	      , "/STAN=C99" , deprec ),
_X_ARG( "check"  	, compile, warn	, 0	      , "ENA=LEVEL5", deprec ),
_X_ARG( "check_bounds"	, compile, noval, check	      , "BOU"       , tru64 ),
_X_ARG( "check_omp"	, compile, noval, 0	      , 0           , tru64 ),
_X_ARG( "common"	, compile, noval, 0	      , "/STAN=COM" , deprec ),
_X_ARG( "cpp"           , compile, noval, 0           , 0           , t64usup ),
_X_ARG( "double" 	, compile, noval, 0	      , "/PREC=DOU" , deprec ),
_X_ARG( "error_limit" 	, compile, val	, 0	      , "/ERR"      , tru64 ),
_X_ARG( "export-dynamic", compile, noval, 0           , 0           , unsup  ),
_X_ARG( "fast"		, compile, noval, optimize    , "/OPT"      , tru64 ),
_X_ARG( "feedback" 	, compile, val	, 0	      , 0           , tru64 ),
_X_ARG( "float"		, compile, noval, 0	      , "/PREC=SIN" , tru64 ),
_X_ARG( "float_const"	, compile, noval, 0	      , 0           , unknown ),
_X_ARG( "fp_reorder"   	, compile, noval, 0	      , 0           , tru64 ),
_X_ARG( "fprm" 		, compile, val	, lookup,
                            "|c=/ROU=C|d=/ROU=D|m=/ROU=M|n=/ROU=N"  , tru64 ),
_X_ARG( "fptm" 		, compile, val	, lookup,
                            "|n=/IEEE=FAS|u=/IEEE=INEX"             , tru64 ),
...
_X_ARG( "g0"		, compile, noval, nodebug     , "/NODEB"    , tru64 ),
_X_ARG( "g1"		, compile, noval, debug	      ,
                                     "/DEB=(NOSYM,TRA)"             , tru64 ),
_X_ARG( "g2"		, compile, noval, debug	      ,
                                     "/DEB=ALL/NOOPT"               , tru64 ),
_X_ARG( "g3"		, compile, noval, debug	      , "/DEB=ALL"  , tru64 ),
_X_ARG( "gen_feedback"	, compile, noval, 0	      , 0           , unknown ),
_X_ARG( "granularity"	, compile, val	, 0	      , "/GRA"      , tru64 ),
_X_ARG( "hpath"		, compile, noval, 0	      , 0           , unknown ),
_X_ARG( "ieee"		, compile, noval, 0	      , "/FL=IEEE"  , tru64 ),
_X_ARG( "ifo"		, compile, noval, 0	      , 0           , tru64 ),
_X_ARG( "include"	, compile, val	, first_include	, ""        , active ),
_X_ARG( "inline"	, compile, val	, optimize    , "INL"       , tru64 ),
_X_ARG( "intrinsics"  	, compile, noval, optimize    , "INTR"      , tru64 ),
_X_ARG( "isoc94"	, compile, noval, 0	      ,
                                     "/STAN=ISOC94"                 , deprec ),
_X_ARG( "machine_code"	, compile, noval, 0	      , "/MAC"      , deprec ),
_X_ARG( "member_alignment" , compile, noval, 0	      , "/MEM"      , tru64 ),
_X_ARG( "misalign"	, compile, noval, 0	      , 0           , tru64 ),
_X_ARG( "mp"		, compile, noval, 0	      , 0           , tru64 ),
_X_ARG( "ms" 		, compile, noval, 0	      , "/STAN=MS"  , badimp ),
...
_X_ARG( "nestlevel="	, compile, xval	, 0	      , 0           , tru64 ),
_X_ARG( "newc"          , compile, xval , 0           , 0           , t64usup),
_X_ARG( "noansi_alias"	, compile, noval, 0	      , "/NOANS"    , tru64 ),
_X_ARG( "noansi_args"	, compile, noval, 0	      , 0           , tru64 ),
_X_ARG( "nocheck_bounds", compile, noval, check	      , "NOBOU"     , tru64 ),
_X_ARG( "nocurrent_include", compile, noval, 0	      , "/NEST=NONE", tru64 ),
_X_ARG( "noerror_limit"	, compile, noval, 0	      , "/NOERR"    , tru64 ),
_X_ARG( "nofp_reorder"  , compile, noval, 0	      , 0           , tru64 ),
_X_ARG( "noinline" 	, compile, val	, optimize    , "NOINL"     , tru64 ),
_X_ARG( "nointrinsics"  , compile, noval, optimize    , "NOINT"     , tru64 ),
_X_ARG( "nomember_alignment", compile, noval, 0	      , "/MEM"      , tru64 ),
_X_ARG( "nomisalign"	, compile, noval, 0	      , 0           , tru64 ),
_X_ARG( "noobject"	, compile, noval, noobject    , "/NOOBJ"    , deprec ),
_X_ARG( "nopg"		, compile, noval, 0	      , 0           , tru64 ),
_X_ARG( "nopids"	, compile, noval, 0	      , 0           , unknown ),
_X_ARG( "oldcomment"	, compile, noval, 0	      , "/NOCOM"    , deprec ),
_X_ARG( "om"   		, compile, noval, 0	      , 0           , tru64 ),
_X_ARG( "omp"		, compile, noval, 0	      , 0           , tru64 ),
...
_X_ARG( "pg"		, compile, noval, 0	      , 0           , tru64 ),
_X_ARG( "pids"		, compile, noval, 0	      , 0           , unknown ),
_X_ARG( "pie"		, compile, noval, 0	      , 0           , ignore ),
_X_ARG( "portable"	, compile, noval, warn	      , "ENA=PORT"  , deprec ),
_X_ARG( "preempt_module", compile, noval, 0	      , 0           , tru64 ),
_X_ARG( "preempt_symbol", compile, noval, 0	      , 0           , tru64 ),
...
_X_ARG( "protect_headers", compile, val , 0	      , 0           , tru64 ),
_X_ARG( "protoi"	, compile, noval, proto	      , "ID"        , tru64 ),
_X_ARG( "protos"	, compile, noval, proto	      , "ST"        , tru64 ),
...
_X_ARG( "signed"	, compile, noval, 0	      , "/NOUNS"    , tru64 ),
_X_ARG( "source_listing", compile, noval, 0	      , "/LIS"      , deprec ),
_X_ARG( "speculate" 	, compile, val	, 0	      , 0           , tru64 ),
...
_X_ARG( "std" 		, compile, noval, 0	      , "/STAN=REL" , tru64 ),
_X_ARG( "std0" 		, compile, noval, 0	      , "/STAN=COM" , tru64 ),
_X_ARG( "std1"		, compile, noval, 0	    , "/STAN=ANSI89", tru64 ),
...
_X_ARG( "trapuv"	, compile, noval, check	      , "UNI"       , tru64 ),
_X_ARG( "tune" 		, compile, val	, optimize    , "TUN"       , tru64 ),
_X_ARG( "unroll" 	, compile, val	, optimize    , "UNR"       , tru64 ),
_X_ARG( "unsigned"	, compile, noval, 0	      , "/UNS"      , tru64 ),
_X_ARG( "varargs"	, compile, noval, 0	      , 0           , unknown ),
_X_ARG( "vaxc"		, compile, noval, 0	      , "/STAN=VAXC", deprec ),
_X_ARG( "verbose"	, compile, noval, warn	      , "VERB"      , tru64),
_X_ARG( "volatile"	, compile, noval, 0	      , 0           , unknown),
_X_ARG( "w"		, compile, noval, warn	    , "DISABLE=ALL" , active ),
_X_ARG( "w0"		, compile, noval, warn	      , "ENA=LEVEL3", tru64 ),
_X_ARG( "w1"		, compile, noval, nowarn      , "/NOWAR"    , tru64 ),
_X_ARG( "w2"		, compile, noval, warn	      , "FAT=LEVEL3", tru64 ),
_X_ARG( "w3"		, compile, noval, warn,
                                     "DIS=ALL,FAT=LEVEL3"           , tru64 ),
...
_X_ARG( "weak_volatile"	, compile, noval, assume      , "WEA"       , tru64 ),
_X_ARG( "writable_strings", compile, noval, assume    , "WRI"       , tru64 ),
_X_ARG( "xtaso"		, compile, noval, 0	      , "/POI=LON"  , tru64 ),
_X_ARG( "xtaso_short"	, compile, noval, 0	      , "/POI=SHO"  , tru64 ),

/*
 * Profiling
 */

_X_ARG( "heavy"         , profile, noval, 0           , 0           , t64usup),
_X_ARG( "p0"		, profile, noval, 0	      , 0           , tru64 ),
_X_ARG( "p1"		, profile, noval, 0	      , 0           , tru64 ),
...
_X_ARG( "all"		, linker,  noval, link_all    , ""          , tru64 ),
_X_ARG( "auto_symvec"   , linker,  noval, auto_symvec , ""          , deprec ),
_X_ARG( "as-needed"	, linker,  noval, 0	      , 0           , unsup ),
_X_ARG( "-as-needed"	, linker,  noval, 0	      , 0           , unsup ),
_X_ARG( "call_shared"   , linker,  noval, 0           , "/SYSSHR"   , tru64 ),
_X_ARG( "check_registry", linker,  val	, 0           , 0           , tru64 ),
_X_ARG( "compress"	, linker,  noval, 0	      , 0           , unknown ),
_X_ARG( "cord"		, linker,  noval, 0	      , 0           , tru64 ),
_X_ARG( "error_unresolved", linker, noval, 0          , 0           , t64usup),
_X_ARG( "exact_version" , linker,  noval, 0	      , 0           , t64usup),
_X_ARG( "expect_unresolved", linker, val, 0	      , 0           , t64usup),
_X_ARG( "fini" 		, linker,  val	, 0	      , 0           , unknown ),
_X_ARG( "hidden"        , linker,  noval, 0           , 0           , unknown ),
_X_ARG( "hide"          , linker,  noval, 0           , 0           , t64usup),
_X_ARG( "history"       , linker,  noval, 0           , 0           , t64usup),
_X_ARG( "i"		, linker,  noval, link_incr   , ""          , active ),
_X_ARG( "init"		, linker,  val	, 0	      , 0           , unknown ),
_X_ARG( "input"         , linker,  val  , 0           , 0           , unknown ),
...
_X_ARG( "no_archive"    , linker,  noval, 0           , "/NOSYSLIB" , tru64 ),
_X_ARG( "non_shared"	, linker,  noval, 0	      , "/NOSYSSHR" , tru64 ),
_X_ARG( "none"		, linker,  noval, link_none   , ""          , tru64 ),
_X_ARG( "pthread"	, linker,  noval, 0	 , "/THREADS_ENABLE", tru64 ),
...
_X_ARG( "set_version" 	, linker,  val	, 0	      , 0           , tru64 ),
_X_ARG( "shared"	, linker,  noval, shared      , "/SHARE"    , tru64 ),
_X_ARG( "soname" 	, linker,  val	, 0	      , 0           , tru64 ),
_X_ARG( "taso"		, linker,  noval, 0	      , 0           , tru64 ),
_X_ARG( "threads"	, linker,  noval, 0	, "/THREADS_ENABLE" , deprec ),
_X_ARG( "T"             , linker,  val   , 0	      , 0           , t64usup ),
_X_ARG( "update_registry", linker, val   , 0	      , 0           , t64usup ),
_X_ARG( "undefined"     , linker,  val   , 0	      , 0           , t64usup ),
_X_ARG( "-undefined"    , linker,  val   , 0	      , 0           , unsup ),
_X_ARG( "z,"            , linker,  xval  , 0	      , 0           , unsup ),
_X_ARG( "z"             , linker,  xval  , 0	      , 0           , unsup ),
_X_ARG( "-version-script", linker, noval, 0           , 0           , unsup ),
_X_ARG( "warning_unresolved", linker, noval, 0        , 0           , t64usup ),

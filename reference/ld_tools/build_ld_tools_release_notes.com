$! File: build_ld_tools_release_notes.com
$!
$! Build the release note file from the three components:
$!    1. The ld_tools_release_note_start.txt
$!    2. The ld_tools_build_steps.txt.
$!
...
$!
$!
$ type/noheader sys$disk:[]ld_tools_release_note_start.txt,-
        sys$disk:[]ld_tools_build_steps.txt -

$! File: build_ld_tools_pcsi_text.com
$!
$! Build the *.pcsi$text file from the four components:
$!    1. Generated =product header section
$!    2. readme. file from the Ld_tools distribution, modified to fit
$!       a pcsi$text file format.
$!    3. copying file from the Ld_tools distribution, modified to fit
$!       a pcsi$text file format.
...
$!
$!
$! 25-Jul-2014  J. Malmberg - Ld_tools version
$!
$!===========================================================================
$!
...
$!-----------------------------------------------------------------
$ readme_file = "product.txt"
$ copying_file = "copying.txt"
$!

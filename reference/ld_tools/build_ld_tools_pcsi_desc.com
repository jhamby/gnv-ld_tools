$! File: build_ld_tools_pcsi_desc.com
$!
...
$!   Add file lines for ld_tools files.
$!   Add Link alias procedure file (used for gnv$ld.exe)
$!   Add [.SYS$STARTUP]gnv$ld_tools_startup file
$!   Add Release notes file.
$!
$! The file pcsi_ld_tools_file_list.txt is read in to get the files other
...
$! Fortunately LD_TOOLS does not trip most of these issues, so those steps
...
$! remove aliases
$   line_out = -
       "  ""@pcsi$destination:[gnv.vms_bin]ld_tools_alias_setup.com remove"""
$   i = 0
$ex_rem_loop:
...
$       write pdsc line_out
$   endif
$   line_out = "  ""@pcsi$destination:[gnv.vms_bin]remove_old_ld_tools.com"","
$   write pdsc line_out
$   line_out = "  ""@pcsi$destination:[gnv.vms_bin]ld_tools_alias_setup.com"""
$   i = 0
$ex_pins_loop:
$       line = f$element(i, ",", add_alias_lines)
$       i = i + 1
...
$ write pdsc "     source [vms_bin]gnv$ld_tools_startup.com ;"
$!
$!   Add Release notes file.
$!------------------------------
$ write pdsc -

$! File: pcsi_product_ld_tools.com
$!
$! This command file packages up the product LD_TOOLS into a sequential
$! format kit
$!
...
$!----------------------------------------------------------
$ @make_pcsi_ld_tools_kit_name.com 'p1' 'p2'
$!
...
$!----------------------------------------------
$ @backup_ld_tools_src.com
$!
$! Regenerate the PCSI description file.
$!--------------------------------------
$ @build_ld_tools_pcsi_desc.com
$!
$! Regenerate the PCSI Text file.
$!---------------------------------
$ @build_ld_tools_pcsi_text.com
$!
$!

$! File: stage_ld_tool_install.com
$!
...
$!
$! The file pcsi_ld_tool_file_list.txt is read in to get the files other
...
$   if f$search("''file'exe") .nes. "" then set file/remove 'file'exe;*
$ endif
$return
